...
class TypeController extends AbstractController
{
     ...
     */
    public function index(TypeRepository $typeRepository, Request $request, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $typeRepository->findBy([], ["id" => "DESC"]), /* query NOT result */
