...
function getElements() {
    dateDebutElem = document.getElementById("reservationclient_date_debut");
    dateFinElem = document.getElementById("reservationclient_date_fin");
}
...
function getDatesValues() {
    console.log(document.getElementById("reservationclient_date_debut").value);
    console.log(document.getElementById("reservationclient_date_fin").value);
    retrieveDataAjax();
}
