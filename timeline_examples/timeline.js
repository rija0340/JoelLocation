    ...
    loadSampleData() {
        ...
        this.cars = [
            ...
            },
            {
                ...
                color: '#8B5CF6',
                customer: null,
                nextBooking: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000)
            },
            {
                id: 4,
            ...
            },
            {
                ...
                nextBooking: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000)
            },
            {
                id: 6,
                name: 'Audi A4 2023',
            ...
            },
            {
                ...
                color: '#F97316',
                customer: null,
                nextBooking: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000)
            }
        ];
