 ...
 */
final class Version20210818110216 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis_garantie (devis_id INT NOT NULL, garantie_id INT NOT NULL, INDEX IDX_13DC356C41DEFADA (devis_id), INDEX IDX_13DC356CA4B9602F (garantie_id), PRIMARY KEY(devis_id, garantie_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE devis_options (devis_id INT NOT NULL, options_id INT NOT NULL, INDEX IDX_42DB61DB41DEFADA (devis_id), INDEX IDX_42DB61DB3ADB05F1 (options_id), PRIMARY KEY(devis_id, options_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
